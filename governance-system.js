...
class GovernanceSystem {
     ...
     */
    openGovernanceModal() {
        console.log('Opening governance modal...');
        ...
        if (modal.parentElement !== document.body) {
            console.log('Moving modal to body from:', modal.parentElement?.id || modal.parentElement?.className);
        ...
        console.log('Modal moved to body and styles applied');
